...
class RoomTypeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: ctext("Room Type", fontSize: 20, fontWeight: FontWeight.w700),
          centerTitle: true,
          elevation: 0,
          backgroundColor: AppColors.scafflodBackground),
      bottomNavigationBar: btmNavBar(context),
      body: GetBuilder<RoomTypeController>(
        initState: (_) {},
        builder: (_) {
  ...
  addData(BuildContext context, RoomTypeController _) {
    _.name.clear();
    _.status = 1;
    List<Widget> addBank = [
      cTextField(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  cButton("Add Room Type", onTap: () {
                    _.name.text.isEmpty
                        ? EasyLoading.showError("Please Write Proper Room Type")
                        : _.addAPI();
  ...
  updateData(RoomTypeController _,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  cButton("Update Room Type", onTap: () {
                    _.name.text.isEmpty
                        ? EasyLoading.showError("Please Write Proper Room Type")
                        : _.updateAPI(id_);
                  }, btnColor: AppColors.iconBG)

...
class MealPlanScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: ctext("Meal Plan", fontSize: 20, fontWeight: FontWeight.w700),
          centerTitle: true,
          elevation: 0,
          backgroundColor: AppColors.scafflodBackground),
  ...
  addData(BuildContext context, MealPlanController _) {
    _.name.clear();
    _.status = 1;
    List<Widget> addBank = [
      cTextField(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  cButton("Save", onTap: () {
                    _.name.text.isEmpty
                        ? EasyLoading.showError("Please Write Proper Meal Plan")
                        : _.addAPI();
  ...
  updateData(MealPlanController _,

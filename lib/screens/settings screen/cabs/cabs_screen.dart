  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: ctext("Cab", fontSize: 20, fontWeight: FontWeight.w700),
          centerTitle: true,
          elevation: 0,
          backgroundColor: AppColors.scafflodBackground),
      bottomNavigationBar: btmNavBar(context),
      body: GetBuilder<CabsController>(
        initState: (_) {},
        builder: (_) {
                        ...
                        itemBuilder: (context, index) {
                          return cCard(
                            ...
                            child: Column(
                              ...
                              children: [
                                textWithHeading(
                                    subTitle: _.dataList[index]['cab_name']
                                        .toString(),
                                    title: "Name"),
                                textWithHeading(
                                    ...
                                    title: "Destination"),
                                textWithHeading(
                                    subTitle: _.dataList[index]['cab_type']
                                        .toString(),
                                    title: "Cab Type"),
                                textWithHeading(
                                    subTitle:
                                        _.dataList[index]['details'].toString(),
                                    title: "Cab Details"),
                                widgetWithHeading(
                                    title: "Status",
                                    subTitle: cCard(
    ...
    List<Widget> addBank = [
      ...
      cTextField(
        ...
        textField: cCard(
            ...
            child: GetBuilder<CabsController>(
              init: CabsController(),
              initState: (_) {},
              builder: (_) {
                return Row(
